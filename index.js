...
function onSubmit(event){
    ...
    let codigo = frmCodigo[1];//values[0][1];
    const nombre = frmNombre[1];//values[1][1];
    const cantidad = frmCantidad[1];//values[2][1];
    const precio = frmPrecio[1];//values[3][1];
    const categoria = frmCategoria[1];//values[4][1];
